...
// initialize FlagGameFragments and start the quiz
            FlagGameFragments quizFragment = (FlagGameFragments)getSupportFragmentManager().findFragmentById(R.id.quizFragment);
