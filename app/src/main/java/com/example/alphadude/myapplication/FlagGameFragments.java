...
/**
 * Created by alphadude on 5/7/17.
 */

public class FlagGameFragments extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =
                inflater.inflate(R.layout.fragment_flag, container, false);
...
// get references to GUI components
        ...
        questionNumberTextView =
                (TextView) view.findViewById(R.id.questionNumberText_View);
...
// get the number of guess buttons that should be displayed
        String choices =
                sharedPreferences.getString(FlagGame.CHOICES, null);
...
// display appropriate guess button LinearLayouts
    ...
    public void updateRegions(SharedPreferences sharedPreferences) {
        regionsSet =
                sharedPreferences.getStringSet(FlagGame.REGIONS, null);
    }
